...
class AddNewActivityViewController: UIViewController, UITextFieldDelegate, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        defaultImages = [#imageLiteral(resourceName: "baseball"), #imageLiteral(resourceName: "bike"), #imageLiteral(resourceName: "bus"), #imageLiteral(resourceName: "car"), #imageLiteral(resourceName: "cart"), #imageLiteral(resourceName: "cricket"), #imageLiteral(resourceName: "flight"), #imageLiteral(resourceName: "football"), #imageLiteral(resourceName: "gaming"), #imageLiteral(resourceName: "garden"), #imageLiteral(resourceName: "hockey"), #imageLiteral(resourceName: "paint"), #imageLiteral(resourceName: "phone"), #imageLiteral(resourceName: "sail"), #imageLiteral(resourceName: "soccer"), #imageLiteral(resourceName: "swimming"), #imageLiteral(resourceName: "tools"), #imageLiteral(resourceName: "train"), #imageLiteral(resourceName: "Work"), #imageLiteral(resourceName: "Eat"), #imageLiteral(resourceName: "Sleep"), #imageLiteral(resourceName: "Read"), #imageLiteral(resourceName: "Walk"), #imageLiteral(resourceName: "Internet"), #imageLiteral(resourceName: "Shop"), #imageLiteral(resourceName: "Exercise"), #imageLiteral(resourceName: "Sport"), #imageLiteral(resourceName: "bath"), #imageLiteral(resourceName: "book"), #imageLiteral(resourceName: "brush"), #imageLiteral(resourceName: "Cinema"), #imageLiteral(resourceName: "meditation"), #imageLiteral(resourceName: "music"), #imageLiteral(resourceName: "study"), #imageLiteral(resourceName: "tea"), #imageLiteral(resourceName: "tv"), #imageLiteral(resourceName: "dance"), #imageLiteral(resourceName: "chill"), #imageLiteral(resourceName: "guitar"), #imageLiteral(resourceName: "home-1"), #imageLiteral(resourceName: "piano"), #imageLiteral(resourceName: "skiing"), #imageLiteral(resourceName: "truck"), #imageLiteral(resourceName: "violin"), #imageLiteral(resourceName: "workout")]
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.defaultImage.backgroundColor = CustomUIFunctions.imageBackgroundColor(index: indexPath.row)
